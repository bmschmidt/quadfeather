...
def parse_args():
    ...
    parser.add_argument('--max_files',
        type=float,
        default = 25,
        help = "Max files to have open. Default 25; check ulimit -n to see what might be safe. "
               "Usually it's much faster to have significantly fewer files than the max.")
